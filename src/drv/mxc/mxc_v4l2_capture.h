...
extern void mxc2_camera_common_lock(void);
extern void mxc2_camera_common_unlock(void);
...
extern int bg_overlay_sdc_select(void *private);
extern int csi_enc_select(void *private);
extern int csi_enc_deselect(void *private);
extern int foreground_sdc_select(void *private);
extern int foreground_sdc_deselect(void *private);
extern int prp_enc_select(void *private);
extern int prp_enc_deselect(void *private);
extern int prp_vf_sdc_select_bg(void *private);
extern int prp_vf_sdc_deselect_bg(void *private);
extern int prp_vf_sdc_select(void *private);
extern int prp_vf_sdc_deselect(void *private);
extern int prp_still_select(void *private);
extern int prp_still_deselect(void *private);
