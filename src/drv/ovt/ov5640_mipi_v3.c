			...
			const struct i2c_device_id *id)
{
	...
	dev_err(dev, "Going to register ov5640 camera!\n");
...
//v4 use isl79987 configuration
#define	I2CDRV_MODULE_NAME		"isl79987_mipi_v3"
#define	I2CDRV_COMPATIBLE_NAME	"isl,isl79987_mipi_v4"
